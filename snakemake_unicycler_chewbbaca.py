...
rule gunzip:
    input:
        ...
        R1= BASE_DIR + "/dataset1_spades_2/{sample}_75X_GQ_1.fq.gz",
        R2= BASE_DIR + "/dataset1_spades_2/{sample}_75X_GQ_2.fq.gz"
    output:
        # Decompressed files
        R1= BASE_DIR + "/dataset1_spades_2/{sample}_75X_GQ_1.fq",
        R2= BASE_DIR + "/dataset1_spades_2/{sample}_75X_GQ_2.fq"
    shell:
